          ...
          <div className="bg-black/30 backdrop-blur-sm border border-white/10 rounded-lg overflow-hidden">
            <div className="p-6 md:p-8">
              <p className="text-xl md:text-2xl italic mb-6 text-love-soft">
                "It was never one moment. It was something quiet and real."
              </p>
              ...
              <p className="text-lg md:text-xl mb-4 text-white/90">
                We were friends first, and little by little, something deeper
                began to grow between us.
              </p>

              <p className="text-lg md:text-xl text-white/90">
                Then came the day I let my heart speak, and I asked you to be
                mine.
              </p>
            </div>
          </div>

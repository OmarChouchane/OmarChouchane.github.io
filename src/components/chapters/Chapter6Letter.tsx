...
const letterParagraphs = [
  "My Dearest Wew Wew,",
  "I wanted to create something special for you, something that would make you feel as loved as you truly are. This is my heart, digitized and carrying my warmth to you.",
  "Since the moment we met you've filled my days with unexpected joy and gentle laughter; each moment with you is a gift I hold close.",
  "I made this because I love you, because our love is a quiet, living work of art that deserves to be celebrated, remembered, and shared.",
  "Happy birthday Maryouma, my love. May the years ahead give us countless new memories to weave into our story.",
  "Forever yours,",
  "Omar",
];
...
const Chapter6Letter: React.FC = () => {
  ...
  return (
    <div
      className="chapter-section bg-gradient-to-b from-love-dark to-[#1a181d]"
      ref={letterRef}
    >
      <FadeInSection>
              ...
              <div key={index} className="mb-6">
                <p
                  className={`text-lg md:text-xl ${
                    index === 0 || index === letterParagraphs.length - 1
                      ? "italic text-love-soft"
                      : ""
                  }`}
                >
                  {paragraph}
